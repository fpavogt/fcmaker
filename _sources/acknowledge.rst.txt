...
2) If you use fcmaker for your observations (and remember that you did so by the time you
   ...
   greatly appreciated::
    ...
    ESO-compliant finding charts. \textsc{fcmaker} relies on \textsc{matplotlib} 
    (Hunter 2007), \textsc{astropy}, a community-developed core Python package 
    for Astronomy (Astropy Collaboration et al., 2013), \textsc{astroplan} (Morris et al. 
    2018), \textsc{aplpy}, an open-source plotting package for Python (Robitaille 2012), 
    ...
    France. The original description of the VizieR 
    ...
    https://www.cosmos.esa.int/web/gaia/dpac/consortium). Funding for the DPAC has been 
